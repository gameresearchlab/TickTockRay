...
[CustomEditor(typeof(WeatherZoneExample_C_Mobile))] 
public class WeatherZoneEditor_C_Mobile : Editor {
	...
	public string weatherType = "";
	  ...
	  enum WeatherTypeDropDown
		...
		WeatherZoneExample_C_Mobile self = (WeatherZoneExample_C_Mobile)target;
